...
class getTodoControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\TodoController'] = $instance = new \App\Controller\TodoController(($container->privates['debug.serializer'] ?? self::getDebug_SerializerService($container)), new \App\Service\OpenAIService($container->getEnv('OPENAI_API_KEY'), $a), $a);
